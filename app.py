    ...
    children=[
        ...
        html.Div(
            [
                ...
                html.Div([
                    html.H4(children='Death Recovered',
                            style={
                                'margin-top': '15px',
                                'text-align': 'center',
                                'color': 'white'
                ...
                html.Div([
                    html.H4(children='PRAWA KOLUMNA',
                            style={
                                'margin-top': '15px',
                                'text-align': 'center',
                                'color': 'white'
        ...
        #
        # html.Div([
        #     html.H3(children='Death Recovered',
        #             style={
        #                 'textAlgin': 'center',
        #                 'color': 'white'}
        #         ),
